...
<body class="boxed-layout container">
   ...
   <div class="wrapper">
      ...
      <!-- End Header -->
       ...
       <div class="container content">
           <?php  if(isset($_GET['page']) == "register") { ?>  
           <?php include_once('userregister.php');  ?> 
           <?php }else { include_once('cgshealthlogin.php'); } ?>
   ...
   <script src="../config/scripts/app/jquery-2.1.4.min.js"></script>
   ...
   <script type="text/javascript" src="../config/content/assets/plugins/back-to-top.js"></script>
    <link rel="stylesheet" href="../config/content/assets/plugins/fancybox/source/jquery.fancybox.css">    
   <!-- JS Page Level -->           
