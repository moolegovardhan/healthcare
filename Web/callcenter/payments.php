...
function showPatientSearch(){
    ...
    window.location.href = "callcenterindex.php?page=payments&patientname="+patientname+"&start="+start+"&end="+end;
...
function nextSetOfRecords(){
    ...
    window.location.href = "callcenterindex.php?page=payments&start="+start+"&end="+end;
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                     <button data-dismiss="modal" class="btn-u btn-u-orange" type="button" id="submitPatientPaymentDetails">Submit</button>
