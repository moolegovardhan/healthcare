       ...
       <section class="col col-md-10">
             <table class="table table-striped" id="patient_medicines_order_patient_table">
                ...
                <tbody>
                    ...
                    if(sizeof($patientData) > 1){ foreach($patientData as $data){ ?>
                    <tr>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                                ...
                                <label class="select">
                                     ...
                                     <option value="Promotional">Promotional</option>
                                      ...
                                      <option value="Silver">Silver</option>    
                                        ...
                                        <option value="30">3,00,000</option> 
                                         <option value="45">4,50,000</option>
                                        <option value="75">7,50,000</option> 
                                     </select>
                ...
                <div class="modal-footer">
                     <button data-dismiss="modal" class="btn-u btn-u-orange" type="button" id="submitPatientCardDetails">Submit</button>
