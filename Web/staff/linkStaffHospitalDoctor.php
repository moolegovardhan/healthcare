...
$md = new MasterData();
//if($_POST['name'] == ""){
$userData = $md->getNonActiveStaffUsers('Doctor',$_POST['name']);
//} else {
...
<div class="col-md-12 sky-form">
    ...
    <form action="../../Business/ActivateStaffDoctorUser.php" method="POST">
     ...
     <div  class="pull-right">
             ...
             <input type="submit" value="Attach Doctor's to <?php echo $hosiptalName[0]->hosiptalname;?>"class="btn-u btn-u-primary" id="activateUser" <?php if($count < 1){ echo "disabled";}?>/>
     </div>
