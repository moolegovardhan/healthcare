...
<script src="../js/childmedicine.js"></script>
        ...
        <div class="tab-content">
            ...
            <div class="tab-pane fade in" id="profile">
                <fieldset> 
                    ...
                    <form name="generalinfo" action="../../Business/StaffChildMedicalInfoSave.php" method="POST">  
                    <section class="col-md-15 sky-form" id="enternewdetails">

                         <div class="panel panel-orange" id="reportssearchpanel">
                             <input type="submit" class="btn-u btn-u-orange pull-right"  name="submit" id="submitChildMedicalParameters" value="Submit Medical Info"/>     



                            <div class="panel-heading">
                                <h3 class="panel-title">Child : Medicines Details </h3>
                                  </div>
                             <div class="panel-body"> 
                                 <div class="row">
                                  ...
                                  <section class="col-md-6">
                                     ...
                                     <section class="col-md-4">
                                         <input type="button" class="btn-u btn-u-orange pull-right"  name="button" id="addChildMedicineParameters" value="Add Medicines Info"/>     
                                     </section>    
                                 </div>
                                 <div class="row">
                                    <table class="table table-striped pull-left" id="child_medicine_info_table">
                                        <thead>
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-body">
                  ...
                  <style type="text/css">
                        ...
                        <div class="row">
                                    ...
                                    <section class="col-md-3">
                                      <label class="input">
                                        <input type="text" id="umedicinename" name="umedicinename"  placeholder="Medicine Name">
                                      </label>
                                      <i><font color="red"><span id="weighterrormsg"></span></font></i>
                                  </section>
                ...
                <div class="modal-footer">
                      <button data-dismiss="modal" class="btn-u btn-u-dark-blue" type="button" id="submitChildMedicineDataEdit">Submit</button>
