...
<div class="col-md-12"> 
    ...
    <?php } ?>
  <form id="registerform"  action="../../Business/PhotoUpload.php?page=fromPatient" method="POST" class="sky-form"  enctype="multipart/form-data">   
 <fieldset>
    <div class="col-md-14">
        <div class="row">
        ...
        <fieldset>
          ...
          <!-- end of section 4 -->
            ...
            <div class="modal-footer">
                ...
                <input type="submit" value="Register User" class="btn-u btn-u-primary" id="registerAdminUser" onclick="onClickRegisterUser()"/>
