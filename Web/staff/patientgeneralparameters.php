<div class="col-md-8 ">
    <fieldset> 
        <section class="col-md-15" id="searchresult">
            <?php include_once 'patientparameterssearch.php'; ?>
        </section>
    </fieldset>   
    
    <!-- Tab Start -->
    <div class="tab-v1" id="enterdetails">
        ...
        <div class="tab-content">
            ...
            <div class="tab-pane fade in active" id="home">
                ...
                <section class="col col-md-15">
                    <div class="panel panel-orange margin-bottom-10" id="listofpatients">
                       ...
                       <table class="table table-striped pull-left" id="patient_existing_records_search_result_table">
                           <thead>
                               <tr>
                                   <th nowrap>ID </th>
            ...
            <div class="tab-pane fade in" id="profile">
                <fieldset> 
                    ...
                    <form name="generalinfo" action="../../Business/StaffPatientGeneralInfoSave.php" method="POST">  
                    <section class="col-md-15 sky-form" id="enternewdetails">

                         <div class="panel panel-orange" id="reportssearchpanel">
                             <input type="submit" class="btn-u btn-u-dark-blue pull-right"  name="submit" id="submitPatientGeneralParameters" value="Submit General Info"/>     



                            <div class="panel-heading">
                                <h3 class="panel-title">Patient : General Details </h3>
                                  </div>
                             <div class="panel-body"> 
                                 <div class="row">
                                      <section class="col-md-5">
                                        <label class="input">
                                          <input type="text" id="paramname" name="paramname"  placeholder="Paramaeter Name">
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                      <button data-dismiss="modal" class="btn-u btn-u-dark-blue" type="button" id="submitGeneralDataEdit">Submit</button>
