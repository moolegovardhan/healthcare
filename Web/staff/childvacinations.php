...
<script src="../js/childvacination.js"></script>
        ...
        <div class="tab-content">
            ...
            <div class="tab-pane fade in active" id="home">
                ...
                <section class="col-md-15">
                    <div class="panel panel-orange margin-bottom-10" id="pregnancyparameters">
                       ...
                       <table class="table table-striped pull-left" id="child_vacination_existing_records_search_result_table">
                           <thead>
                               <tr>
                                   <td nowrap>Month</td>
                                   <td nowrap>Vacination Name</td>
            ...
            <div class="tab-pane fade in" id="profile">
                <fieldset> 
                    ...
                    <form name="generalinfo" action="../../Business/StaffChildVacinationInfoSave.php" method="POST">  
                    <section class="col-md-15 sky-form" id="enternewdetails">

                         <div class="panel panel-orange" id="reportssearchpanel">
                             <input type="submit" class="btn-u btn-u-orange pull-right"  name="submit" id="submitChildVacinationParameters" value="Submit Vacination Info"/>     



                            <div class="panel-heading">
                                <h3 class="panel-title">Child : Vacination Details </h3>
                                  </div>
                             <div class="panel-body"> 
                                 <div class="row">
                                    ...
                                    <section class="col-md-3">
                                      <label class="input">
                                        <input type="text" id="vacinename" name="vacinename"  placeholder="Vacine Name">
                                      </label>
                                  ...
                                  <section class="col-md-6">
                                     ...
                                     <section class="col-md-4">
                                         <input type="button" class="btn-u btn-u-orange pull-right"  name="button" id="addChildVacinationParameters" value="Add Vacine Info"/>     
                                     </section>    
                                 </div>
                                 <div class="row">
                                    <table class="table table-striped pull-left" id="child_vacination_info_table">
                                        <thead>
                                            <tr class="bg-color-orange">

                                                <td nowrap>Month</td>
                                                <td nowrap>Vacination Name</td>
                                                <td nowrap>Observation</td>
                                                <td nowrap></td>
                                            </tr>
                                        </thead>
                                        <tbody>
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-body">
                  ...
                  <style type="text/css">
                        ...
                        <div class="row">
                                    ...
                                    <section class="col-md-3">
                                      <label class="input">
                                        <input type="text" id="uvacinename" name="uvacinename"  placeholder="Vacination Name">
                                      </label>
                                      <i><font color="red"><span id="weighterrormsg"></span></font></i>
                                  </section>
                                  ...
                                  <section class="col-md-6">
                                      <label class="input">
                                          <textarea rows="6" cols="35" id="uobservations" name="uobservations"></textarea>
                                      </label>
                                      <i><font color="red"><span id="observationerrormsg"></span></font></i>
                                  </section>
                ...
                <div class="modal-footer">
                      <button data-dismiss="modal" class="btn-u btn-u-dark-blue" type="button" id="submitChildVacinationDataEdit">Submit</button>
