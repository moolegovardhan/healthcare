...
<script src="../js/childgeneral.js"></script>
        ...
        <div class="tab-content">
            ...
            <div class="tab-pane fade in active" id="home">
                ...
                <section class="col-md-15">
                    <div class="panel panel-orange margin-bottom-10" id="pregnancyparameters">
                       ...
                       <table class="table table-striped pull-left" id="child_existing_records_search_result_table">
                           <thead>
                               <tr>
                                   <td nowrap>Month</td>
                                   <td nowrap>Weight</td>
            ...
            <div class="tab-pane fade in" id="profile">
                <fieldset> 
                    ...
                    <form name="generalinfo" action="../../Business/StaffChildGeneralInfoSave.php" method="POST">  
                    <section class="col-md-15 sky-form" id="enternewdetails">

                         <div class="panel panel-orange" id="reportssearchpanel">
                             <input type="submit" class="btn-u btn-u-orange pull-right"  name="submit" id="submitChildGeneralParameters" value="Submit General Info"/>     



                            <div class="panel-heading">
                                <h3 class="panel-title">Child : General Details </h3>
                                  </div>
                             <div class="panel-body"> 
                                 <div class="row">
                                  ...
                                  <section class="col-md-6">
                                     ...
                                     <section class="col-md-4">
                                         <input type="button" class="btn-u btn-u-orange pull-right"  name="button" id="addChildGeneralParameters" value="Add General Info"/>     
                                     </section>    
                                 </div>
                                 <div class="row">
                                    <table class="table table-striped pull-left" id="child_general_info_table">
                                        <thead>
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-body">
                  ...
                  <style type="text/css">
                        ...
                        <div class="row">
                                    ...
                                    <section class="col-md-3">
                                      <label class="input">
                                        <input type="text" id="upulse" name="upulse"  placeholder="Pulse">
                                      </label>
                                      <i><font color="red"><span id="bperrormsg"></span></font></i>
                                  </section>
                                  <section class="col-md-6">
                ...
                <div class="modal-footer">
                      <button data-dismiss="modal" class="btn-u btn-u-dark-blue" type="button" id="submitChildGeneralDataEdit">Submit</button>
