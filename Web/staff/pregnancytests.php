  ...
  <script src="../js/pregnancymedicaltest.js"></script>
        ...
        <div class="tab-content">
                ...
                <section class="col-md-15">
                    <div class="panel panel-orange margin-bottom-10" id="pregnancyparameters">
                       <div class="panel-heading">
                           <h3 class="panel-title"><i class="fa fa-edit"></i>List of Test</h3>
                       </div>
            ...
            <div class="tab-pane fade in" id="profile">
                <fieldset> 
                    ...
                    <form name="generalinfo" action="../../Business/StaffPregnancyTestInfoSave.php" method="POST">  
                    <section class="col-md-15 sky-form" id="enternewdetails">

                         <div class="panel panel-orange" id="reportssearchpanel">
                             <input type="submit" class="btn-u btn-u-orange pull-right"  name="submit" id="submitPrgenancyMedicalTestParameters" value="Submit Test Info"/>     



                            <div class="panel-heading">
                                <h3 class="panel-title">Pregnancy : Medical Test Details </h3>
                                  </div>
                             <div class="panel-body"> 
                                 <div class="row">
                                  ...
                                  <section class="col-md-6">
                                     ...
                                     <section class="col-md-4">
                                         <input type="button" class="btn-u btn-u-orange pull-right"  name="button" id="addPregnancyMedicalTestParameters" value="Add Medicines Info"/>     
                                     </section>    
                                 </div>
                                 <div class="row">
                                    <table class="table table-striped pull-left" id="pregnancy_test_info_table">
                                        <thead>
...
<div class="modal fade sky-form-modal-overlay" id="myParametersModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                  ...
                  <style type="text/css">
                        ...
                        <div class="row">
                                      <section class="col col-3">
                                            <label class="select">
                                              <select id="tmonth" name="tmonth" class="form-control">
                                               <option value="MONTH">- Month -</option>
                                               <option value="0">0</option>
                                               <option value="1">1</option>
                                               <option value="2">2</option>
                                    ...
                                    <section class="col-md-3">
                                      <label class="input">
                                        <input type="text" id="ttestname" name="ttestname"  placeholder="Test Name">
                                      </label>
                                  ...
                                  <section class="col-md-6">
                                      <label class="input">
                                          <textarea rows="6" cols="35" id="tobservation" name="tobservation"></textarea>
                                      </label>
                                      <i><font color="red"><span id="observationerrormsg"></span></font></i>
                                  </section>
                ...
                </div>  <input type="hidden" name="generalid" id="generalid"> 
                
                </div>
                <div class="modal-footer">
                      <button data-dismiss="modal" class="btn-u btn-u-dark-blue" type="button" id="submitPregnancyTestDataEdit">Submit</button>
