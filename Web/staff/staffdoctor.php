        ...
        <fieldset>
          ...
          <!-- end of section 4 -->
                      ...
                      <fieldset>
                        ...
                        <fieldset>
                             ...
                             <section>
                                 <label class="input">
                                    <i class="icon-append fa fa-lock"></i>
                                    <input type="text" id="name" name="name" placeholder="First Name"  class="form-control  state-success"   required> <font><i><span id="nameerrormsg"></span></i></font>       
                                </label>
                             ...
                             <section>
                                 <label class="input">
                                    <i class="icon-append fa fa-lock"></i>
                                    <input type="text" id="mname" name="mname" placeholder="Middle Name"  class="form-control  state-success"  > <font><i><span id="mnameerrormsg"></span></i></font>       
                                </label>
                                 </section>
                             <section>
                                 <label class="input">
                                    <i class="icon-append fa fa-lock"></i>
                                    <input type="text" id="lname" name="lname" placeholder="Last Name"  class="form-control  state-success"   required> <font><i><span id="lnamerrormsg"></span></i></font>       
                                </label>
                              </section>
                            <section>
                                 <label class="input">
                                    <i class="icon-append fa fa-lock"></i>
                                    <input type="text" id="aadharcard" placeholder="Aadhar Card"  class="form-control  state-success"   maxlength="12">
             ...
             <div class="row col-md-4">
                     ...
                     <fieldset>
                        ...
                        <section>
                             <label class="input">
                                <i class="icon-append fa fa-user"></i>
                                <input type="text" id="zipcode" placeholder="Zipcode" required    maxlength="6">
                     ...
                     <fieldset>
                        ...
                        <section>
                         ...
                         <section>
                            <label class="input">
                                <i class="icon-append fa fa-user"></i>
                                <input type="text"  value="<?php// echo $hosiptalName[0]->hosiptalname;?>" readonly>
                                  <font><i><span id="starterrormsg"></span></i></font>       
                            </label>
                             <input type="hidden" id="hosiptal" value="<?php// echo $_SESSION['officeid'];?>"/>
                          </section>  
            ...
            <div class="modal-footer">
                ...
                <input type="submit" value="Register User" class="btn-u btn-u-primary" id="registerStaffDoctorUser" />
