...
if($_POST['name'] == ""){
    $diagnosticsList = $dd->fetchListOfMedicalShopCenters($_SESSION['officeid']);
} else {
    $diagnosticsList = $dd->fetchListOfMedicalShopGivenName($_SESSION['officeid'],$_POST['name']);
} 
if(count($userData) > 0){
...
<div class="col-md-12 sky-form">
    <div  class="pull-left">
        ...
        <form action="#" method="POST">
         ...
         <section class="col-md-5">
               <input type="submit" value="Search Medical Shop" class="btn-u btn-u-primary" id="staffDoctor"/>
    ...
    <form action="../../Business/MapLabAndDiagnostics.php" method="POST">
        ...
        <input type="hidden" name="mapfor" id="mapfor" value="medicalshop" >
        <?php if(isset($_GET['msg'])) {?>
            <div class="alert alert-info fade in"><span id="adminErrorMessage">Please select Medical Shop and then press Submit</span></div>
           <?php  } ?>
    ...
    <div class="panel panel-orange margin-bottom-40">
        <div class="panel-heading">
            ...
            <div class="pull-right">
             <input  type="submit" value="Attach Medical Shop to <?php echo $hosiptalName[0]->hosiptalname;?>"class="btn-u btn-u-primary" id="activateUser" <?php if($count < 1){ echo "disabled";}?>/>
           </div>
            </h3>
            ...
            <tbody>
                ...
                <tr>
                    <td><input type="checkbox" value="<?php echo $diagnostics->id;?>" name="<?php echo $count;?>"/></td>
                     <td><?php echo $diagnostics->shopname;?></td>
