...
//alert("hello");
 ...
 //alert("Hello2");
        if(registerAdminStaffFormValidate())
            checkAdminStaffUserId($('#newuser').val());
...
function checkAdminStaffUserId(userId){
   clearAdminStaffValidationMessage();  
...
function registerAdminStaffFormValidate(){
...
function clearAdminStaffValidationMessage(){
    $('#useriderrmsg').html("");
...
function registerAdminStaffNewUser(){
        ...
        if($('#address2').val().length < 1)
        {
         ...
         profession = "Staff"; 
        registerAdminStaffUser($('#newuser').val(),$('#newuserpassword').val(),$('#email').val(),$('#mobile').val(),profession,$('#address1').val(),$('#name').val(), addressline2, $('#district').val(), $('#state').val(), $('#mname').val(),$('#lname').val(), $('#zipcode').val(), appdate, $('#gender').val(),  $('#aadharcard').val(),  $('#city').val(),  $('#hosiptal').val(),  $('#altmobile').val(),  $('#landline').val(),  $('#age').val(),  $('#cardtype').val() );
...
function registerAdminStaffUser(userName,password,email,mobile,profession,address,name,address2,district,state,mname,lname,zipcode,start,gender,aadharcard,city,hosiptal,altmobile,landline,age,cardtype){
