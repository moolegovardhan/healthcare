<?php
session_start();
include_once 'ChildGeneralData.php';
?>
<br/><br/><br/><br/>
...
for($i =1 ; $i<$counter+1; $i++){
   ...
   // echo "paramdata : ".$paramdata;echo "<br/>";
    $param = explode("$", $paramdata);
     $result = $pd->childMonthlyDetails($param[0],$param[1], $param[2], $param[3],$param[4], 'Y', $_SESSION['officeid']);
      //$month,$weight, $height,$pulse, $observation, $status, $hosiptalId
    if($_POST['frommodule'] == ""){
        $message = "Data Updated Successfully";
        $url = "http://".$_SESSION['host']."/".$_SESSION['rootNode']."/Web/staff/staffindex.php?page=chealth";
