...
$height = $_POST['oheight'];
$month = $_POST['omonth'];
$isvacination = $_POST['isvacination'];
...
$ad->insertChildPatientPrescriptionDetails($appointmentId, $patientId, $patientName,$description, $doctorId, $hospitalId, $appointmentDate, $nextappointmentdt,$medicalshop,$inpatient,$suggestions,$weight,$height,$month,$isvacination,$vacination);
...
$url = "http://".$_SESSION['host']."/".$_SESSION['rootNode']."/Business/GeneratePregnancyPrescriptionPDF.php?appointmentid=".$appointmentId;
 ...
 $message = "Data Updated Successfully. ";
    $url = "http://".$_SESSION['host']."/".$_SESSION['rootNode']."/Web/callcenter/callcenterindex.php?page=childprescription";
}catch(Exception $ex){
